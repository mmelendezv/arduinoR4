...
El primer punto con la tarjeta es instalar el software el IDE de Arduino, se recomienda usar una vesion reciente. Al momento es tiene la version 2.3.6 (considerando una instalacion de Windows):
